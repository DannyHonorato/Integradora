            ...
            <div class="rd-navbar-main">
              ...
              <div class="rd-navbar-nav-wrap">
                ...
                <ul class="rd-navbar-nav">
                  <li class="rd-nav-item "><a class="rd-nav-link" href="admin/Categoria.html">Categorías</a>
                  </li>
...
<div class="container">
<div class="header"><center><h1>Mostrar de registros</h1></center></div>
...
?>
      ...
      <div class="rd-navbar-element"><center><a class="button button-sm button-default-outline button-winona" href="prodreg2.html">registrar un nuevo producto</a></center>
      </div>
</div>
            ...
            <div class="row row-50 justify-content-lg-between">
              ...
              <div class="col-sm-7 col-lg-5 col-xl-3">
                ...
                <ul class="list footer-classic-list footer-classic-list_2-cols">
                  <li><a href="/version11/51695/site/logout.php" class="btn btn-danger ml-3">Cerrar sesión</a></li>
                </ul>
              </div>
